...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_setting.setContentsMargins(10, 10, 10, 10)
        ...
        self.horizontalLayout_lowcut.setStretch(0, 5)
        self.horizontalLayout_lowcut.setStretch(1, 5)
        self.horizontalLayout_lowcut.setStretch(2, 90)
        ...
        self.horizontalLayout_highcut.setStretch(0, 5)
        self.horizontalLayout_highcut.setStretch(1, 5)
        self.horizontalLayout_highcut.setStretch(2, 90)
        ...
        spacerItem_power = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_power.addItem(spacerItem_power)
        ...
        self.horizontalLayout_power.setStretch(0, 5)
        self.horizontalLayout_power.setStretch(1, 5)
        self.horizontalLayout_power.setStretch(2, 90)
        ...
        spacerItem_voltage = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_voltage.addItem(spacerItem_voltage)
        ...
        self.horizontalLayout_voltage.setStretch(0, 5)
        self.horizontalLayout_voltage.setStretch(1, 5)
        self.horizontalLayout_voltage.setStretch(2, 90)
        ...
        spacerItem_current = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_current.addItem(spacerItem_current)
        ...
        self.horizontalLayout_current.setStretch(0, 5)
        self.horizontalLayout_current.setStretch(1, 5)
        self.horizontalLayout_current.setStretch(2, 90)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.value_power.setText(_translate("MainWindow", "None"))
        self.label_voltage.setText(_translate("MainWindow", "電壓:"))
        self.value_voltage.setText(_translate("MainWindow", "None"))
        self.label_current.setText(_translate("MainWindow", "電流:"))
        self.value_current.setText(_translate("MainWindow", "None"))
